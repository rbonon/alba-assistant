...
**Updated:** 2026-07-08 (#14–#17 closed)  
...
| **P1 Requirements & spec v1** | **In Progress** (#2 open) | **`rbo-create-change`** on **#18 — [Grill] P1 — Success metrics per persona** |
...
```text
rbo-create-change → #18 — [Grill] P1 — Success metrics per persona
```
