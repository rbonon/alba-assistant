...
**Updated:** 2026-07-08 (#21 closed D-052–D-057)  
...
| **P1 Requirements & spec v1** | **In Progress** (#2 open) | **`rbo-create-change`** on **#22 — [Grill] P1 — Google Calendar scope** |
...
```text
rbo-create-change → #22 — [Grill] P1 — Google Calendar scope
```
