...
**Next:** `rbo-create-change` on **#16 — [Grill] P1 — Privacy, LGPD & sensitive content**. #14–#15 closed (D-015–D-025). See [`docs/planning/session-handoff.md`](docs/planning/session-handoff.md).
